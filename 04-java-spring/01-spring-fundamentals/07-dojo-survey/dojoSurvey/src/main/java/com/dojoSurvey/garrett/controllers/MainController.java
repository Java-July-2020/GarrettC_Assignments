package com.dojoSurvey.garrett.controllers;
...
import com.dojoSurvey.garrett.models.survey;
...
public class MainController {
	...
	private String[] getLocations() {
		return new String[] {"Seattle", "Los Angeles", "New York", "San Francisco", "Chicago"};
	}
	@RequestMapping("/")
